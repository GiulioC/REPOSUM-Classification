 ...
 *
 */
public class PhiloItem implements Serializable,Comparable<PhiloItem> {
	 ...
	 */
	public PhiloItem(String v, PhiloTag t, int cs, int ce) {
		value=v;
		tag=t;
		charStart = cs;
		charEnd = ce;
	...
	public int compareTo(PhiloItem o) {
